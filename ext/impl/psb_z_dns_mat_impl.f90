...
subroutine psb_z_dns_csmv(alpha,a,x,beta,y,info,trans) 
  use psb_base_mod
  use psb_z_dns_mat_mod, psb_protect_name => psb_z_dns_csmv
  implicit none 
  ...
  character(len=20)  :: name='z_dns_csmv'
  ...
  call zgemv(trans_,a%get_nrows(),a%get_ncols(),alpha,&
...
subroutine psb_z_dns_csmm(alpha,a,x,beta,y,info,trans) 
  use psb_base_mod
  use psb_z_dns_mat_mod, psb_protect_name => psb_z_dns_csmm
  implicit none 
  class(psb_z_dns_sparse_mat), intent(in) :: a
  complex(psb_dpk_), intent(in)          :: alpha, beta, x(:,:)
  complex(psb_dpk_), intent(inout)       :: y(:,:)
  ...
  character(len=20)  :: name='z_dns_csmm'
  logical, parameter :: debug=.false.
  ...
  ldx = size(x,1)
  ldy = size(y,1)
  call zgemm(trans_,'N',m,n,k,alpha,a%val,lda,x,ldx,beta,y,ldy)
...
function psb_z_dns_csnmi(a) result(res)
  use psb_base_mod
  use psb_z_dns_mat_mod, psb_protect_name => psb_z_dns_csnmi
  implicit none 
  class(psb_z_dns_sparse_mat), intent(in) :: a
  real(psb_dpk_)         :: res
  !
...
subroutine psb_z_dns_get_diag(a,d,info) 
  use psb_base_mod
  use psb_z_dns_mat_mod, psb_protect_name => psb_z_dns_get_diag
  implicit none 
  class(psb_z_dns_sparse_mat), intent(in) :: a
...
subroutine  psb_z_dns_reallocate_nz(nz,a) 
  use psb_base_mod
  use psb_z_dns_mat_mod, psb_protect_name => psb_z_dns_reallocate_nz
  implicit none 
  integer(psb_ipk_), intent(in) :: nz
  class(psb_z_dns_sparse_mat), intent(inout) :: a
  !
  integer(psb_ipk_) :: err_act
  character(len=20)  :: name='z_dns_reallocate_nz'
  logical, parameter :: debug=.false.
...
subroutine psb_z_dns_mold(a,b,info) 
  use psb_base_mod
  use psb_z_dns_mat_mod, psb_protect_name => psb_z_dns_mold
  implicit none 
  class(psb_z_dns_sparse_mat), intent(in)  :: a
  ...
  allocate(psb_z_dns_sparse_mat :: b, stat=info)
...
subroutine  psb_z_dns_allocate_mnnz(m,n,a,nz) 
  use psb_base_mod
  use psb_z_dns_mat_mod, psb_protect_name => psb_z_dns_allocate_mnnz
  implicit none 
...
subroutine  psb_z_dns_trim(a)
  use psb_base_mod
  use psb_z_dns_mat_mod, psb_protect_name => psb_z_dns_trim
  implicit none 
  class(psb_z_dns_sparse_mat), intent(inout) :: a
  !
  integer(psb_ipk_) :: err_act
...
subroutine psb_z_cp_dns_from_coo(a,b,info) 
  use psb_base_mod
  use psb_z_dns_mat_mod, psb_protect_name => psb_z_cp_dns_from_coo
  implicit none 
...
subroutine psb_z_cp_dns_to_coo(a,b,info) 
  use psb_base_mod
  use psb_z_dns_mat_mod, psb_protect_name => psb_z_cp_dns_to_coo
  implicit none 
...
subroutine psb_z_mv_dns_to_coo(a,b,info) 
  use psb_base_mod
  use psb_z_dns_mat_mod, psb_protect_name => psb_z_mv_dns_to_coo
  implicit none 
...
subroutine psb_z_mv_dns_from_coo(a,b,info) 
  use psb_base_mod
  use psb_z_dns_mat_mod, psb_protect_name => psb_z_mv_dns_from_coo
  implicit none 
